...
function Aviones() {
  return (
    <section className="max-w-7x m-auto h-[100vh]">
      <h1 className="mt-10 text-6xl text-center font-bold text-[#003459]">¿Te Gustaría Volar en Nuestros Aviones?</h1>

      <div className="w-full mt-10 flex justify-center items-center">
        <div className="w-[90%] h-96 flex justify-evenly items-center gap-4 p-5 ">
